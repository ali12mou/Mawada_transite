...
const document9Schema = new mongoose.Schema(
  {
    ...
    invoice_count: { type: String, default: '' },
    ...
    dossier_fee: { type: String, default: '' },
    truck_load_quantity: { type: String, default: '' },
    transit_fee: { type: String, default: '' },
    service_fee: { type: String, default: '' },
    pass_cancel_fee: { type: String, default: '' },
    transfer_total: { type: String, default: '' },
    ...
    price_number_9: { type: String, default: '' },
    doc_number_4_file: { type: String, default: '' },
    price_number_4: { type: String, default: '' },
    doc_ti_cancel_file: { type: String, default: '' },
    price_ti_cancel: { type: String, default: '' },
    doc_declaration_se_cancel_file: { type: String, default: '' },
    price_declaration_se_cancel: { type: String, default: '' },
  },
