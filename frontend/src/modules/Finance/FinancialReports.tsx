  ...
  const fetchData = async () => {
    try {
      const [expensesRes, categoriesRes, allocationsRes] = await Promise.all([
        genericApi.list('expenses').order('expense_date', { ascending: false }),
        genericApi.list('expense_categories'),
        genericApi.list('expense_allocation').order('month', { ascending: false })
      ]);
