...
export interface Document9Record {
  ...
  declaration_s?: number;
  declaration_e?: number;
  dossier_fee?: number;
  truck_load_quantity?: number;
  transit_fee?: number;
  service_fee?: number;
  pass_cancel_fee?: number;
  ...
  price_number_9?: number;
  doc_number_4_file?: string;
  price_number_4?: number;
  doc_ti_cancel_file?: string;
  price_ti_cancel?: number;
  doc_declaration_se_cancel_file?: string;
  price_declaration_se_cancel?: number;
  createdAt?: string;
  updatedAt?: string;
}
